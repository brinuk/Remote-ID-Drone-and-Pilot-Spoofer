...
void Spoofer::update() {
  ...
  //create a new base
  utm_data.base_latitude = 53.871427  + (float) (rand() % 10 - 5) / 2000.0;
  utm_data.base_longitude =  -1.733222 + (float) (rand() % 10 - 5) / 2000.0;
